...
const iBseize_list=["Geofencing Marketing","Location based service","iBeacon based Product","Customer Rating","Inproving Campaigns","Retailer-customer hub"]
const ui_list = [" Prototyping", "wireframing", "user flows", "mockups", "Visual design and design software","User research and usability testing","Agile","Information architecture","Application development"];
const digitalmarketing_list=["Search Engine Optimization (SEO)","Search Engine Marketing (SEM)","Website Strategy","Social Media Marketing","Email Outreach","Re-targeting","Content Generation and Optimization","Quality Link Building","Affiliate Marketing","Integrated Online Marketing Strategies"]
const videography_list=["Photography","Editing","Creative skills","Proficiency with softwares","Captions, Graphics","Animation","3D rendering"]
const webdevelopment_list=["HTML/CSS","Analytical","Responsive design","JavaScript","Testing and debugging","Deployment","Back-end","Search engine optimization"]
const medicalcoding_list=["Audit and submit claims","Obtain insurance referrals","Verify insurance eligibility and benefits","Understand insurance guidelines","Review patient bills","Check payments","Research and appeal","Set up payment plans","Medical terminology","Accounting and bookkeeping","Excellent communication","Attention to detail"]
const dataentry_list=["Attention to detail","Effective Multitasking","Verbal and written comm.","Spreadsheets","Databases","Sorting Documents","Transcribing","Word Processing","Resolving Discrepancies"]
  ...
  return (
    ...
    <div className="service-card-wrapper">
      ...
      <div className="bigFlex">
        <div className="service-card-image-container">{props.video?<video muted autoPlay={"autoplay"} loop src={props.video} />:<img className="image-for" src={props.image}/>}
